...
class ApiDocGeneratorTest extends TestCase
{
    public function testCache()
    {
        ...
        $generator = new ApiDocGenerator([new DefaultDescriber()], [], new DiscardNamespaceModelNamingStrategy(), $adapter);
    ...
    {
        $adapter = new ArrayAdapter();
        $generator = new ApiDocGenerator([new DefaultDescriber()], [], new DiscardNamespaceModelNamingStrategy(), $adapter, 'custom_id');
